...
public class WordCount{
	...
	public ConcurrentMap<String, Integer> stopWordLib = new ConcurrentHashMap<>();
	...
	public WordCount(File input){
		...
		try{
			...
			while(inputRead.ready()){
                        ...
                        if(stopWordLib.containsKey(word)){
							System.out.println(word);
							int stopWordCount = stopWordLib.get(word);
                        	stopWordCount++;
                        	stopWordLib.put(word, stopWordCount++);
	...
	public static void main(String[] args){
		...
		File input = new File(args[0]);
            ...
            WordCount wordCounter = new WordCount(input);
			wordCounter.print();
        }
